...
export function renderCharBed(container) {
  ...
  const expRequiredButton = el('button', ['hidden', 'inline-flex', 'items-center', 'justify-center', 'rounded-lg', 'border', 'border-[#b6d7da]', 'bg-white', 'px-4', 'py-2', 'text-teal-700', 'hover:bg-teal-50', 'w-full', 'md:w-auto']);
